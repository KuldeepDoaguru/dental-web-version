...
//   const logoutTime = moment(time).format("HH:mm:ss");
  ...
  const getTodayAttendance = async () => {
    ...
    try{
        const response = await axios.get(`https://dentalgurulab.doaguru.com/api/lab/getTodayAttendance/${branch_name}/${employee_ID}/${date}`,
        {
          headers: {
 ...
 useEffect(() => {
  ...
  console.log(todayAttendance)
    const handleLogin = async () => {
      ...
      try {
       const response =  await axios.post("https://dentalgurulab.doaguru.com/api/lab/markAttendanceLogin", {
          branch_name,
          employee_ID,
          employee_name,
    ...
    const handleLogout = async () => {
      ...
      try {
       const response =  await axios.put("https://dentalgurulab.doaguru.com/api/lab/markAttendanceLogout", { branch_name,
        employee_ID,
        employee_name,
        employee_designation,
        date,
