...
//       password: empData[0]?.employee_password,
...
//                 <SiderAdmin />
//               </div>
//               <div className="col-lg-11 col-md-10 col-11 ps-0 mx-4" style={{marginTop:"3rem"}}>
  ...
  return (
    <>
      <Container>
        ...
        {/* other pop-up */}
        {/* pop-up for adding lab */}
        <div className={`popup-container${showEditEmployee ? " active" : ""}` } style={{marginTop:"2rem"}}>
          <div className="popup">
