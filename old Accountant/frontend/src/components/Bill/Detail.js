...
function Detail() {
      ...
      <Modal show={show} onHide={handleClose}>
        ...
        <form>
          <div class="mb-3 d-flex gap-2">
            <label for="recipient-name" class="col-form-label">UHID :</label>
           <p className='mt-2'>DH19 </p>
          </div>
          <div class="mb-3 d-flex gap-2">
            <label for="recipient-name" class="col-form-label">RGID :</label>
           <p className='mt-2'>RG5</p>
          </div>
          <div class="mb-3 d-flex gap-2">
            <label for="message-text" class="col-form-label">Patient Name :</label>
           <p className='mt-2'>Mohit Sahu</p>
          ...
          <div class="mb-3 d-flex gap-2">
            <label for="message-text" class="col-form-label">Treatment Amount:</label>
            <p className='mt-2'>3000</p>
          </div>
          <div class="mb-3 d-flex gap-2">
 ...
 <button type="button" class="btn btn-primary mt-4 mx-3" id='button1'>Print</button>
