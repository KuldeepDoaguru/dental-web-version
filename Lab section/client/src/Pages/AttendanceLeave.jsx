...
const AttendanceLeave = () => {
  ...
  const getAttendance = async () => {
    ...
    try{
        const response = await axios.get(`https://dentalgurulab.doaguru.com/api/lab/getAttendancebyempId/${branch}/${employeeId}`,
        {
          headers: {
 ...
 useEffect(() => {
  ...
  const getLeaves = async () => {
    ...
    try{
        const response = await axios.get(`https://dentalgurulab.doaguru.com/api/lab/get-leaves/${branch}/${employeeId}`,
        {
          headers: {
            'Content-Type': 'application/json',
            'Authorization': `Bearer ${token}`
