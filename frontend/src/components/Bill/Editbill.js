   ...
   <>
      ...
      <Modal show={show} onHide={handleClose}>
        ...
        <form>
          ...
          <div class="mb-3">
            <label for="message-text" class="col-form-label">RGID:</label>
            <input type="text" class="form-control" id="recipient-name"/>
          </div>
          <div class="mb-3">
          ...
          <div class="mb-3">
            <label for="message-text" class="col-form-label">Moblie No :</label>
            <input type="text" class="form-control" id="recipient-name"/>
          </div>
          <div class="mb-3">
          ...
          <div class="mb-3">
            <label for="message-text" class="col-form-label">Payme:</label>
            <input type="text" class="form-control" id="recipient-name"/>
          </div>
          <div class="mb-3">
