...
router.get("/getOPDDetailsByBranch/:branch", authenticate, getOPDDetailsByBranch);
router.get("/getTreatmentDetailsByBranch/:branch", authenticate, getTreatmentDetailsByBranch);
router.post("/voucherCreate", authenticate, voucherCreate);
router.get("/getVoucherListByBranch/:branch", authenticate, getVoucherListByBranch);
...
router.get(
  "/getAppointmentDetailsViaIDOPD/:id", authenticate,
  getAppointmentDetailsViaIDForOPD
);
router.get(
...
router.get("/getEmployeeListByBranch/:branch", authenticate, getEmployeeListByBranch);
router.post("/addEmployeeSalary/:branch", authenticate, addEmployeeSalary);
router.get(
  "/getEmployeeListByBranchByID/:branch/:slid", authenticate,
  getEmployeeListByBranchByID
);
...
router.get(
  "/getTodayAttendance/:branch/:employee_ID/:date", authenticate,
  getTodayAttendance
);
...
router.get("/getTreatmentTotal/:appointID/:uhid", authenticate, getTreatmentTotalById);
router.get(
  "/getSecurityAmountDataByTPUHID/:tpid/:uhid", authenticate,
  getSecurityAmountDataByTPUHID
);
router.put("/updateRemainingAmount/:tp_id/:uhid", authenticate, updateRemainingAmount);
router.put(
