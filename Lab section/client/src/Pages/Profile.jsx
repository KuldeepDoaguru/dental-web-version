  ...
  const getEmployeeData = async () => {
    try {
      const { data } = await axios.get(
        `https://dentalgurulab.doaguru.com/api/lab/getEmployeeDetails/${branch}/${user.employee_ID}`,
        {
          headers: {
  ...
  const editEmployeeData = async (e) => {
    ...
    try {
      ...
      const response = await axios.put(
        `https://dentalgurulab.doaguru.com/api/lab/editEmployeeDetails/${branch}/${user.employee_ID}`,
        formData,
        {
          headers: {
            "Content-Type": "multipart/form-data",
