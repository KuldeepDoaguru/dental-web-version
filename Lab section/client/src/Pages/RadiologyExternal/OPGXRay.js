...
import signature from "../BloodTestExternal/signature_maker_after_.webp";
...
const OPGXRay = () => {
  ...
  const testNames = [
    ...
    { name: "Occlusal X-rays" },
    { name: "Cone Beam Computed Tomography (CBCT)" },
    { name: "Bitewing X-rays" },
  ];
  const unitsName = ["500", "750", "850"];
  const dummy = {
    test: "",
    value: "",
    unit: "",
                    ...
                    <div className="row d-print-none">
                      <div className="d-flex justify-content-between">
                        <div className="col-lg-4 form-group">
                          <label className="fw-bold fs-5">X - Ray Name</label>
                          <input
                            list="TestName"
                            ref={inputRef}
                      ...
                      <div className="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12">
                        <table className=" bg-white text-center table table-borderless">
                          <thead className="border ">
                            <th className="p-3">X - Ray Name</th>
