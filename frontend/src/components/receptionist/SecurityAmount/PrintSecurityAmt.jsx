            ...
            <table className="table table-borderless">
              <tbody>
                <tr>
                  ...
                  <td className='text-capitalize'>{": "}{data[0]?.appointment_id}</td>

                  
  
    <th scope="col" className='text-start'>Patient id</th>
    <td  className='text-capitalize'>{": "}{data[0]?.uhid}</td>
    
<th scope="col" className='text-start'>Branch Name</th>
<td  className='text-capitalize'>{": "}{data[0]?.branch_name}</td>
                ...
                <tr>
                  ...
                  <td  className='text-capitalize'>{": "}{data[0]?.patient_name}</td>
                  <th scope="col" className='text-start pe-5'>Mobile No</th>
    <td  className='text-capitalize'>{": "}{data[0]?.patient_number}</td>
                ...
                <tr>
                  ...
                  <td  className='text-capitalize'>{": "}{data[0]?.assigned_doctor}</td>
                  <th scope="col" className='text-start'>Payment Date</th>
                  <td  className='text-capitalize'>{": "}{data[0]?.payment_date ? moment(data?.created_at).format('DD/MM/YYYY') : ""}</td>
                  <th scope="col" className='text-start'>Payment Mode</th>
                  <td  className='text-capitalize'>{": "}{data[0]?.payment_Mode}</td>
                ...
                <tr>
                 ...
                 <td  className='text-capitalize'>{": "}{data[0]?.transaction_Id}</td> </>} 
...
<div className="row proc-detail" >
  ...
  <tbody>
                  ...
                  <tr >
                    ...
                    <th scope="col" className='text-end pe-4 pt-4'> {data[0]?.amount}{".00"}</th>
                ...
                <tr>
                  ...
                  <th scope="col" className='text-end pe-4'>{data[0]?.amount}{".00"}</th>
