   ...
   <Wrapper className="container">
      ...
      <Modal show={show} onHide={handleClose}>
        ...
        <form>
          ...
          <div class="mb-3 d-flex gap-2">
            <label for="message-text" class="col-form-label">Patient id :</label>
           <p className='mt-2'>P57789</p>

          </div>
          <div class="mb-3 d-flex gap-2">
            <label for="message-text" class="col-form-label">Patient Mobile:</label>
                <p className='mt-2'>9456687475</p>
          </div>
          <div class="mb-3 d-flex gap-2">
            <label for="message-text" class="col-form-label">Bill Number:</label>
            <p className='mt-2'>B585858</p>
          </div>
          <div class="mb-3 d-flex gap-2">
            <label for="message-text" class="col-form-label">Bill Date:</label>
